            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="{{ url('/') }}" class="navbar-brand"> 
                  <div class="brand-text brand-big hidden-lg-down"><span>Pens</span><strong>Sheart</strong></div>
                  <div class="brand-text brand-small"><strong>PH</strong></div></a>
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Create Users</h2>
            </div>
          </header>
                          ...
                          <section class="dashboard-counts no-padding-bottom">
					            <div class="container-fluid">
					              <div class="row bg-white has-shadow title">
                                       ...
                                       {!! Form::open([ 'medthod'=>'POST', 'action'=>'AdminUsersController@store' ]) !!}
